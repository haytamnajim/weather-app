...
import { FiCloudRain, FiSun, FiCloud, FiSnowflake, FiDroplet, FiWind, FiThermometer } from 'react-icons/fi';
...
const WeatherCardGlass = ({ weather }) => {
    ...
    const getLiveIcon = (id, size = "60px") => {
        ...
        if (id >= 600 && id < 700) return <FiSnowflake size={size} color="#e2e8f0" />;
